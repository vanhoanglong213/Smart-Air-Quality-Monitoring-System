    ...
    /* USER CODE BEGIN 3 */
		switch(trang_thai){
			...
			case 1:
				...
				break;
			case 2:
				//requet data from mcu, read uart interrupt
				Server_request_data();		
				break;
			case 3:
				resend_command();
				trang_thai = 0;
				break;
			case 4: //send data when server request
				send_data_to_esp();
				trang_thai = 0;
				break;
			default:
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, led_r_Pin|led_b_Pin|led_g_Pin, GPIO_PIN_RESET);
...
//  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_2, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : led_r_Pin led_b_Pin led_g_Pin led_Pin */
  GPIO_InitStruct.Pin = led_r_Pin|led_b_Pin|led_g_Pin|led_Pin;
